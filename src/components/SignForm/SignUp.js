...
export default function SignUp({
  ...
  return (
    <>
      <form
        className={activeSignUp === true ? styles.signup_form : styles.unActive}
      >
        <div className={styles.sign_form_btns_sign_in_up}>
          <p
            className={!activeLogin ?styles.sign_form__sign_in_unActive :styles.sign_form__sign_in}
        ...
        <div className={styles.relative_for_error}>
          ...
          <span className={styles.profile_icon_form}></span>
          <input
            onChange={(e) => {
              nameHandler(e);
              clientDataWriter(e);
